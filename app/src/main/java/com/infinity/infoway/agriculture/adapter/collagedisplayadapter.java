...
//            year = (TextView) view.findViewById(R.id.to_date_next_holiday);
    ...
    @Override
    public collagedisplayadapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_group, parent, false);

        return new collagedisplayadapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(collagedisplayadapter.MyViewHolder holder, int position)
    {
