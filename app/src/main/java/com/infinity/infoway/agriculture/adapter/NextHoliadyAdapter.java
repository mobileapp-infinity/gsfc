...
import com.infinity.infoway.agriculture.model.Movie;
...
public class NextHoliadyAdapter extends RecyclerView.Adapter<NextHoliadyAdapter.MyViewHolder> {
    ...
    @Override
    public NextHoliadyAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.next_holiday_list, parent, false);
        return new NextHoliadyAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(NextHoliadyAdapter.MyViewHolder holder, int position) {
