...
public class ExamTimeTableDetailAdapter extends BaseAdapter
{
    ...
    ExamTimeTableDetailAdapter.ViewHolder viewHolder;
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            ...
            viewHolder = new ExamTimeTableDetailAdapter.ViewHolder();
        ...
        {
            viewHolder = (ExamTimeTableDetailAdapter.ViewHolder) convertView.getTag();
        }
