...
import com.infinity.infoway.agriculture.model.Activity_File_array;
...
//        progressDialog.show();
    ...
    public class StudActivity_horizontal_rec extends RecyclerView.Adapter<StudActivity_horizontal_rec.MyViewHolder>
    {
        ...
        @Override
        public StudActivity_horizontal_rec.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.horizontal_rec_list, parent, false);

            return new StudActivity_horizontal_rec.MyViewHolder(itemView);
        }

        @Override
        public void onBindViewHolder(final StudActivity_horizontal_rec.MyViewHolder holder, final int position) {
