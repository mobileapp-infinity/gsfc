...
//               String lectname1=mValues.get(position+1).getlect_name();
                   ...
                   /* holder.tvSemester.setText(mValues.get(position).getLab_array().get(0).getsm_name());
                    // assert labdetail.get(0).getdvm_name() != null;
                    holder.tvDivision.setText(mValues.get(position).getLab_array().get(0).getdvm_name());
                    //  assert mValues.get(position).getLab_array().get(0).getsub_short_name() != null;
                    holder.tvBatch.setText(mValues.get(position).getLab_array().get(0).getsub_short_name());
                    // assert mValues.get(position).getLab_array().get(0).getrm_name() != null;
                    holder.tvClassroom.setText(mValues.get(position).getLab_array().get(0).getrm_name());
                    ...
                    for (int i = 0; i < labdetail.size(); i++)
                    {
                        ...
                        {
                            holder.batchlayout.setBackgroundColor(a.getResources().getColor(R.color.lllecture2));
