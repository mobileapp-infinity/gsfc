...
public class Group_News_Adapter  extends RecyclerView.Adapter<Group_News_Adapter.MyViewHolder> {
    ...
    @Override
    public Group_News_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.news_list, parent, false);

        return new Group_News_Adapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(Group_News_Adapter.MyViewHolder holder, final int position) {
